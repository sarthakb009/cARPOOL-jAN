...
var _OfflineCreatePackOptions = _interopRequireDefault(require("./OfflineCreatePackOptions.js"));
var _OfflinePack = _interopRequireDefault(require("./OfflinePack.js"));
var _index = require("../../utils/index.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
const MapLibreGL = _reactNative.NativeModules.MLNModule;
const MapLibreGLOfflineManager = _reactNative.NativeModules.MLNOfflineModule;
const OfflineModuleEventEmitter = exports.OfflineModuleEventEmitter = new _reactNative.NativeEventEmitter(MapLibreGLOfflineManager);
/**
...
class OfflineManager {
  ...
  async createPack(options, progressListener, errorListener) {
    ...
    const nativeOfflinePack = await MapLibreGLOfflineManager.createPack(packOptions);
  ...
  async subscribe(packName, progressListener, errorListener) {
    ...
    if ((0, _index.isFunction)(progressListener)) {
      if (totalProgressListeners === 0) {
        this.subscriptionProgress = OfflineModuleEventEmitter.addListener(MapLibreGL.OfflineCallbackName.Progress, this._onProgress);
      }
    ...
    if ((0, _index.isFunction)(errorListener)) {
      if (totalErrorListeners === 0) {
        this.subscriptionError = OfflineModuleEventEmitter.addListener(MapLibreGL.OfflineCallbackName.Error, this._onError);
      }
