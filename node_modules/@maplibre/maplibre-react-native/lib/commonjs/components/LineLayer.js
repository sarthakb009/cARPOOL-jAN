...
const NATIVE_MODULE_NAME = exports.NATIVE_MODULE_NAME = "RCTMLNLineLayer";
const RCTMLNLineLayer = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME);
...
const LineLayer = ({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(RCTMLNLineLayer, {
    ref: setNativeLayer,
    ...baseProps
  });
};
