...
var _AnimatedPoint = _interopRequireDefault(require("../utils/animated/AnimatedPoint.js"));
...
function getShapeFromProps(props = {}) {
  ...
  if (props.animated) {
    return new _AnimatedPoint.default(point);
  }
  return point;
}
function isShapeAnimated(shape) {
  return shape instanceof _AnimatedPoint.default;
}
const Annotation = /*#__PURE__*/(0, _react.forwardRef)(({
  animated = false,
  ...
  if (symbolStyle) {
    children.push(/*#__PURE__*/(0, _jsxRuntime.jsx)(_SymbolLayer.default, {
      id: `${props.id}-symbol`,
      style: symbolStyle
    }));
  }
