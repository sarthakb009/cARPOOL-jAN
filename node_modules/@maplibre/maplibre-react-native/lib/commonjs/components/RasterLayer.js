...
const NATIVE_MODULE_NAME = exports.NATIVE_MODULE_NAME = "RCTMLNRasterLayer";
const RCTMLNRasterLayer = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME);
const RasterLayer = ({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(RCTMLNRasterLayer, {
    ref: setNativeLayer,
    ...baseProps
  });
};
