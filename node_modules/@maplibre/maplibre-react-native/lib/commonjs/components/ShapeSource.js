...
exports.default = exports.SHAPE_SOURCE_NATIVE_ASSETS_KEY = exports.NATIVE_MODULE_NAME = void 0;
...
const NATIVE_MODULE_NAME = exports.NATIVE_MODULE_NAME = "RCTMLNShapeSource";
const SHAPE_SOURCE_NATIVE_ASSETS_KEY = exports.SHAPE_SOURCE_NATIVE_ASSETS_KEY = "assets";
/**
 * ShapeSource is a map content source that supplies vector shapes to be shown on the map.
 * The shape may be a url or a GeoJSON object
 */
const ShapeSource = /*#__PURE__*/(0, _react.memo)(/*#__PURE__*/(0, _react.forwardRef)(({
  ...
  async function getClusterExpansionZoom(feature) {
    if (typeof feature === "number") {
      ...
      const res = await _runNativeCommand("getClusterExpansionZoomById", _nativeRef.current, [feature]);
      return res.data;
    }
  ...
  async function getClusterLeaves(feature, limit, offset) {
    if (typeof feature === "number") {
      console.warn("Using cluster_id is deprecated and will be removed from the future releases. Please use cluster as an argument instead.");
      const res = await _runNativeCommand("getClusterLeavesById", _nativeRef.current, [feature, limit, offset]);
      if ((0, _index.isAndroid)()) {
        return JSON.parse(res.data);
      }
      return res.data;
  ...
  async function getClusterChildren(feature) {
    if (typeof feature === "number") {
      console.warn("Using cluster_id is deprecated and will be removed from the future releases. Please use cluster as an argument instead.");
      const res = await _runNativeCommand("getClusterChildrenById", _nativeRef.current, [feature]);
      if ((0, _index.isAndroid)()) {
        return JSON.parse(res.data);
      }
      return res.data;
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(RCTMLNShapeSource, {
    ...shapeProps,
...
const RCTMLNShapeSource = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME);
var _default = exports.default = ShapeSource;
