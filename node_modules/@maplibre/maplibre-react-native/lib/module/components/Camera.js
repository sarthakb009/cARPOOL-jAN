...
import { CameraModes } from "../MLNModule.js";
...
const Camera = /*#__PURE__*/memo(/*#__PURE__*/forwardRef(({
  animationMode,
  animationDuration,
  bounds,
  centerCoordinate,
  ...
  const nativeCamera = useNativeRef();
  ...
  return /*#__PURE__*/_jsx(RCTMLNCamera, {
    testID: "Camera",
    ref: nativeCamera,
    stop: nativeStop,
...
const RCTMLNCamera = requireNativeComponent(NATIVE_MODULE_NAME);
