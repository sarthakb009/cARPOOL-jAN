 ...
 */
const PointAnnotation = /*#__PURE__*/forwardRef(({
  anchor = {
    x: 0.5,
    y: 0.5
  },
  ...
  return /*#__PURE__*/_jsx(RCTMLNPointAnnotation, {
    ...nativeProps,
...
const RCTMLNPointAnnotation = requireNativeComponent(NATIVE_MODULE_NAME);
