...
import { Box, VStack, HStack, Text, Icon, Button, Menu, Pressable, Spinner } from 'native-base';
    ...
    >
      <Box style={styles.headerSection}>
        ...
        <VStack space={4} alignItems="center" pb={6}>
          ...
          >
            <Text style={[styles.avatarText, { fontSize: 18 }]}>{getInitials()}</Text>
          </Box>
          <VStack alignItems="center" space={2}>
            <Text style={[styles.userName, { fontSize: 22 }]}>
              {driverData.driverFirstName || 'Driver'} {driverData.driverLastName || ''}
            </Text>
            <HStack space={2} alignItems="center">
              <Icon as={FontAwesome5} name="star" size={3} color="yellow.400" />
              <Text style={styles.ratingText}>
                {driverData.avgRating ? `${driverData.avgRating.toFixed(1)} Rating` : 'No ratings yet'}
              </Text>
            </HStack>
            <Box
              bg="green.50"
          ...
          <Text style={[styles.motto, { marginTop: 4 }]}>
        ...
        <Box style={styles.cardContainer}>
          <HStack justifyContent="space-between" alignItems="center" mb={6}>
            ...
            <Button
              ...
              _text={{ color: 'gray.600', fontSize: 'xs', fontWeight: '600' }}
            >
              Add Vehicle
            </Button>
          </HStack>
